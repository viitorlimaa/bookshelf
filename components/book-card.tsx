...
import { Star, Eye, Edit, Trash2, Router } from "lucide-react";
...
export function BookCard({ book, onEdit, onDelete }: BookCardProps) {
  ...
  return (
   <Card className="group hover:shadow-lg transition-all duration-200 hover:-translate-y-1 flex flex-col cursor-pointer w-full sm:w-[200px] md:w-[220px] lg:w-[240px]">
  {/* Capa do livro */}
  <div className="w-full relative pb-[130%] sm:pb-[130%] rounded-md overflow-hidden">
    <Image
    ...
    />
     ...
     <CardContent className="flex flex-col flex-1 p-2 sm:p-3">
