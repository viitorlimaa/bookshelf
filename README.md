...
│ ├── biblioteca/ # Rota da biblioteca
│ │ └── page.tsx # Página de listagem de livros
│ ├── adicionar-livro/ # Rota de adição de livros
...
│ │
│ ├── book-card.tsx # Card de exibição de livro
...
│ └── use-book-store.ts # Hook para store de livros (Zustand)
│
├── lib/ # Utilitários e configurações
│ ├── utils.ts # Funções utilitárias (cn, etc)
│ ├── validations.ts # Schemas de validação Zod
│ └── api.ts # Cliente API e requisições
│
